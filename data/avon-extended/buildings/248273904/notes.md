...
- Portico: `open` porch across the full road face, `d` 2.4, four cream posts and `roof: "main"`. The house's hip roof and deep entablature extend over the recessed porch, with the columns meeting the entablature underside at 6.47 m. The main body stays set back 2.4 m (v -9.4), putting the porch's front edge on the OSM front line. Wide grey stair (6 steps) centred on the door. This replaces the detached flat porch roof whose 7.0 m post height above the 1.0 m floor put it above the main eaves.
